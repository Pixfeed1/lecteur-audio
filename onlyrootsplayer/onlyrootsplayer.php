...
class OnlyRootsPlayer extends Module
{
    ...
    public function install()
    {
        ...
        $defaults = [
            ...
            // staging-validated fix for the v2.4.8 production breakage. Operators
    ...
    private function renderMonitorPanel()
    {
        ...
        // page (observed in v2.4.8 production when an operator clicked
        // "Vider le log").
    ...
    private function getSwupExcludePaths()
    {
        ...
        // ZOneTheme on /fr/nous-contacter — captured in the v2.4.8 monitor
        // log).
        $pageNames = [
