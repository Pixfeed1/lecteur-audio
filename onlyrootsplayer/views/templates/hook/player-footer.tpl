...
<div id="orp-player" class="orp-player" style="display:none;" data-playing="false" role="region" aria-label="{l s='Lecteur audio' mod='onlyrootsplayer'}">
    <div class="orp-player-inner">
        ...
        <div class="orp-controls">
            <button class="orp-btn orp-btn-prev" id="orp-prev" type="button"
                    title="{l s='Piste précédente' mod='onlyrootsplayer'}"
                    aria-label="{l s='Piste précédente' mod='onlyrootsplayer'}">
            ...
            <button class="orp-btn orp-btn-play" id="orp-play" type="button"
                    title="{l s='Lecture / Pause' mod='onlyrootsplayer'}"
                    aria-label="{l s='Lecture ou pause' mod='onlyrootsplayer'}">
            ...
            <button class="orp-btn orp-btn-next" id="orp-next" type="button"
                    title="{l s='Piste suivante' mod='onlyrootsplayer'}"
                    aria-label="{l s='Piste suivante' mod='onlyrootsplayer'}">
        ...
        <div class="orp-info">
            ...
            <div class="orp-progress-wrap" id="orp-progress-wrap">
                <div class="orp-progress-bar" role="slider" aria-label="{l s='Progression' mod='onlyrootsplayer'}" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" tabindex="0">
        ...
        <div class="orp-volume-wrap">
            <button class="orp-btn orp-btn-vol" id="orp-vol-btn" type="button"
                    title="{l s='Volume' mod='onlyrootsplayer'}"
                    aria-label="{l s='Couper ou rétablir le son' mod='onlyrootsplayer'}">
            ...
            <div class="orp-volume-bar-wrap" id="orp-volume-wrap">
                <div class="orp-volume-bar" role="slider" aria-label="{l s='Volume' mod='onlyrootsplayer'}" aria-valuemin="0" aria-valuemax="100" aria-valuenow="80" tabindex="0">
        ...
        <button class="orp-btn orp-btn-close" id="orp-close" type="button"
                title="{l s='Fermer' mod='onlyrootsplayer'}"
                aria-label="{l s='Fermer le lecteur' mod='onlyrootsplayer'}">
